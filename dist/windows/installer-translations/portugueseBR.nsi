...
LangString inst_warning ${LANG_PORTUGUESEBR} "O qBittorrent está em execução e precisa ser fechado para que a instalação prossiga."
;LangString inst_uninstall_question ${LANG_ENGLISH} "Current version will be uninstalled. User settings and torrents will remain intact."
LangString inst_uninstall_question ${LANG_PORTUGUESEBR} "A versão atual será desinstalada. Porém, as configurações e os torrentes do usuário permanecerão intactos."
...
LangString uninst_warning ${LANG_PORTUGUESEBR} "O qBittorrent está em execução e precisa ser fechado para que a desinstalação prossiga."
